...
- Benchmarks 계약은 skills + commerce 계약에서 타깃을 생성합니다 (`pnpm run generate:benchmarks`). 측정값은 `pnpm run experiment`로 채우며, 현재 measured 228건(`qwen3.6-27b` 114 + `qwen-2.5-0.5b` 114) + illustrative 시드를 함께 보관합니다.
